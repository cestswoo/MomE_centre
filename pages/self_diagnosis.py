...
def main():
    ...
    # 에딘버러 tab
        ...
        st.header('K-EPDS')
        st.write("K-EPDS(Korean version of Edinburgh Postnatal Depression Scale)는 현재 가장 많이 사용되고 있는 산후우울증 선별 검사도구입니다. 전형적인 우울검사보다 산후우울증을 경험하면서 겪게 되는 증상들을 평가하고 있습니다. Cox 등에 의해 1987년 개발되었고 우리나라에서는 김용구 등에 의해 2005년 번안되고 표준화 된 검사도구입니다.  ")
        st.write("")
        ...
        with sub_tab1:
            ...
            if st.button("결과 확인하기", key="edin_result"):
                ...
                if total_score >= 13:
                    ...
                    st.warning("상담이 필요합니다. 산후 우울증 위험이 높은 것으로 나타났습니다. 전문가의 상담을 받아보시는 것이 좋습니다. 무엇이든 치료보다는 예방이 좋습니다. 조금 더 정확한 결과를 알아보고 싶다면 정신건강의학과를 방문해 상담과 진료를 받아보시길 바랍니다.")
                else:
                    st.success("정상 범위입니다. 산후 우울증 위험이 낮은 것으로 나타났습니다. 그러나 주변 지원 및 관리가 필요할 수 있습니다. 자신의 감정을 받아들이고 남편 및 가족들과 나누며, 신체적 정서적 안정을 유지하는 것이 좋습니다.")
    ...
    # PHQ-9 tab
           ...
           # st.write("지난 2주 동안 다음과 같은 문제를 얼마나 자주 겪었는지 해당되는 항목에 표시해주세요 ")
            ...
            if st.button("결과 확인하기", key="phq_result"):
                ...
                if phq_total_score >= 20:
                    st.error("우울증 위험이 상당히 높습니다. 반드시 정신건강 전문가의 진단을 받아보셔야 합니다. 적절한 치료를 받는 것은 굉장히 중요합니다.")
        ...
        with sub_tab2:
            ...
            with co1:
                ...
                st.write("😢 20-27점")
                st.write("| 우울증 위험이 상당히 높습니다. 반드시 정신건강 전문가의 진단을 받아보셔야 합니다. 적절한 치료를 받는 것은 굉장히 중요합니다.")
